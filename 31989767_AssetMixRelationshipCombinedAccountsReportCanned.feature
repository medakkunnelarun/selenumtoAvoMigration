...
Feature: AssetMixRelationshipCombinedAccountsReportCanned
  I want to verify Asset Mix Relationship Combined Account Report - Premium

  Scenario: 31989767|Verify asset mix relationship combined account report-canned
    ...
    And user selects report category "PremiumReport.PremiumHoldings.AssetMixRelationshipCombinedAccounts"
