...
Feature: Top20HoldingsReportCanned
  I want to verify that premium top 20 holdings report can be generated and security idenfier type/value columns are present in the downloaded xlsx report
@22.4ReportRerun @runnow
  Scenario: 31989773|Verify premium top 20 holdings report
    ...
    And user selects report category "PremiumReport.PremiumHoldings.Top20Holdings"
