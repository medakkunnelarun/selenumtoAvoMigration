...
public abstract class CustomWebElement {
	...
	/**
	 * The element must be visible in order to retrieve its attribute. Get the
	 * value of a the given attribute of the element. Will return the current
	 ...
	 * property with the same name is returned (for example for the "value"
	 * property of a textarea element). If neither value is set, null is
