...
public class WebElementTransformer {
	 ...
	 *
	 * @param findBy
	 *            The FindBy annotation which should be transformed to a By locator.
	 ...
	 *
	 * @param locator
	 *            Locator for which the used type should be returned.
	 ...
	 *
	 * @param locator
	 *            The locator which value should be returned.
	 * @param type
	...
	public String getLocatorValue(By locator, LocatorType type) {
		...
		try {
			...
			case XPATH:
				...
				break;
			default:
				throw new IllegalArgumentException("The locator value for " + locator.toString() + " with the type "
						+ type.toString() + " was not found.");
			}
		} catch (NoSuchFieldException | SecurityException e) {
			throw new RuntimeException("There was a problem to receive the value for the locator " + locator.toString()
					+ " with the type " + type.toString(), e);
		}
		locatorField.setAccessible(true);
		try {
			return (String) locatorField.get(locator);
		} catch (IllegalAccessException e) {
			throw new RuntimeException("There was a problem receiving the value for the locator " + locator.toString()
					+ " with the type " + type.toString(), e);
		}
	}
}
