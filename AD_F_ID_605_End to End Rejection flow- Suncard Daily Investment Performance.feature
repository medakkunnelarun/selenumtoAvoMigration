...
Feature: Rejection flow_Master - Account - Suncard Daily Investment Performance
  I want to verify AD_F_ID_605_Master - Account - Suncard Daily Investment Performance : End to End Rejection flow feature file

  
  Scenario: 48683829|AD_F_ID_605_Master - Account - Suncard Daily Investment Performance : End to End Rejection flow
  #initiate form
  ...
  And user selects value "#RejSuncardDailyParticipation" from angular dropdown "FormAccountsPage.dropdownSuncardDailyParticipation"
  Then user enters value "#NewSuncardParticipantCode" in textbox "FormAccountsPage.textboxSuncardParticipantCode"
  And user clicks on "FormDetailsPage.buttonSubmit"
  ...
  And user navigates to url "http://10.7.148.100/wealthportal95"
	...
	And verify text "#NewSuncardParticipantCode" is present in table "AMIScreens.tblTradeOrders"
